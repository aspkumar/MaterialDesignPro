...
public class StepperFragThree extends Fragment {
    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.frag_stepper_three, container, false);
        ...
        ProgressBar prog = (ProgressBar) controls.findViewById(R.id.progressBar);
        prog.setProgress(100);
        ProgressBar progressBar = (ProgressBar) controls.findViewById(R.id.progressBar2);
